...
const projects = [
  ...
  new ProjectModel({
    ...
    mainSkill: "Golang、MySQL、Restful API、Cloud Run...",
    description:
  ...
  new ProjectModel({
    ...
    mainSkill: "Flutter(Bloc & DDD)、SQLite、Firestore...",
    description:
  ...
  new ProjectModel({
    title: "Chat App",
    mainSkill: "Flutter(Bloc & DDD)、Firestore、Cloud Storage...",
    description:
  ...
  new ProjectModel({
    ...
    mainSkill: "Flutter(Bloc & DDD)、GraphQL、Firebase...",
    description:
  ...
  new ProjectModel({
    ...
    mainSkill: "Flutter(Bloc & MVC)、Restful API(dio)...",
    description:
